...
namespace Lean.Touch
{
	...
	public class xyzPinchScale : MonoBehaviour
	{
		public Image x, y, z;
		...
		protected virtual void Awake()
		{
			...
			x = toggle.transform.GetChild(0).GetComponent<Image>();
			y = toggle.transform.GetChild(1).GetComponent<Image>();
			z = toggle.transform.GetChild(2).GetComponent<Image>();
		}
        ...
        protected virtual void Update()
		{
			...
			if (pinchScale != 1.0f)
			{
                ...
                if (x.enabled)
                {
					transform.localScale = new Vector3 (transform.localScale.x * pinchScale, transform.localScale.y, transform.localScale.z);
				}
				if (y.enabled)
				{
					transform.localScale = new Vector3(transform.localScale.x , transform.localScale.y * pinchScale, transform.localScale.z);
				}
				if (z.enabled)
				{
					transform.localScale = new Vector3(transform.localScale.x , transform.localScale.y, transform.localScale.z * pinchScale);
				}
