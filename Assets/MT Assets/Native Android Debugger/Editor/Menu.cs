...
namespace MTAssets.NativeAndroidDebugger.Editor
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        [MenuItem("Tools/MT Assets/Native Android Debugger/Android Debugger Tool", false, 10)]
        static void OpenAndroidDebuggerTool()
        {
            AndroidDebuggerTool.OpenWindow();
        }

        [MenuItem("Tools/MT Assets/Native Android Debugger/View Changelog", false, 10)]
        ...
        [MenuItem("Tools/MT Assets/Native Android Debugger/Read Documentation", false, 30)]
        ...
        [MenuItem("Tools/MT Assets/Native Android Debugger/More Assets", false, 30)]
        static void MoreAssets()
        {
            Help.BrowseURL(Greetings.linkForAssetStorePage);
        }

        [MenuItem("Tools/MT Assets/Native Android Debugger/Get Support", false, 30)]
